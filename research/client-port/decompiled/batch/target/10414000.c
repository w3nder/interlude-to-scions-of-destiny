...
uint packet_10414000(int param_1,undefined4 param_2)

{
  ...
  uVar2 = func_0x103034e5(*(undefined4 *)(param_1 + 0x48),param_2,0x10885d20,&uStack_44,&uStack_48,
                          &param_1);
  (**(code **)(**(int **)(_DAT_10b1f538 + 0x54) + 0x244))(uStack_44,uStack_48);
  iVar4 = 0;
  if (0 < sStack_4) {
    do {
      ...
      (**(code **)(**(int **)(_DAT_10b1f538 + 0x54) + 0x248))(&uStack_44);
      iVar4 = iVar4 + 1;
    } while (iVar4 < sStack_4);
  }
  uVar3 = _Logf_FOutputDevice__QAAXPBGZZ
                    (*(undefined4 *)_GNetworkLog__3PAVFOutputDevice__A_exref,0x10885d28);
