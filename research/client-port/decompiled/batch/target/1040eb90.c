...
uint packet_1040eb90(int param_1,undefined4 param_2)

{
  ...
  *unaff_FS_OFFSET = &uStack_10;
  ...
  for (iStack_1c = 0; iStack_1c < (short)uStack_20; iStack_1c = iStack_1c + 1) {
    ...
    uVar1 = func_0x103034e5(*(undefined4 *)(param_1 + 0x48),uVar1,0x10884940,&uStack_64,auStack_60,
                            auStack_5c,auStack_68,auStack_4c,auStack_4a,auStack_50,&uStack_48,
                            auStack_44);
    (**(code **)(**(int **)(_DAT_10b1f538 + 0x54) + 0x50c))((int)(short)uStack_18,auStack_68);
    if (((short)uStack_18 == 2) || ((short)uStack_18 == 3)) {
      (**(code **)(**(int **)(_DAT_10b1f538 + 0x54) + 0x408))(uStack_64);
    }
  }
  uVar2 = _Logf_FOutputDevice__QAAXPBGZZ
                    (*(undefined4 *)_GNetworkLog__3PAVFOutputDevice__A_exref,0x108849a0);
  *unaff_FS_OFFSET = uStack_10;
