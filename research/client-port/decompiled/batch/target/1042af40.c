...
uint packet_1042af40(int param_1,undefined4 param_2)

{
  ...
  *unaff_FS_OFFSET = &uStack_10;
  ...
  iStack_8 = 0;
  func_0x103034e5(*(undefined4 *)(param_1 + 0x48),param_2,0x1088a294,auStack_1c,&uStack_20,
                  &uStack_24,&uStack_15,&uStack_16,&uStack_17,&uStack_28,&uStack_18);
  piVar2 = (int *)0x0;
  if (_DAT_10b1f538 != 0) {
      ...
      if (*piVar2 == 1) {
        ...
        if (piVar2[1] != 0) {
          ...
          if (iVar1 != 0) {
            ...
            _PushBack_L2ParamStack__QAEHPAX_Z(uStack_18);
            (**(code **)(**(int **)(_DAT_10b1f538 + 0x54) + 0x72c))
                      (*(undefined4 *)(iVar1 + 0x204),auStack_40);
            _Logf_FOutputDevice__QAAXPBGZZ
                      (*(undefined4 *)_GNetworkLog__3PAVFOutputDevice__A_exref,0x1088a248);
