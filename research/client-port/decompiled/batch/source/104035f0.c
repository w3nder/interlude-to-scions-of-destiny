...
uint packet_104035f0(int param_1,undefined4 param_2)

{
  ...
  uVar2 = func_0x10305079(*(undefined4 *)(param_1 + 0x48),param_2,&UNK_107c2780,&uStack_38,
                          &uStack_3c,&param_1);
  (**(code **)(**(int **)(_DAT_109d5e68 + 0x54) + 0x184))(uStack_38,uStack_3c);
  iVar4 = 0;
  if (0 < sStack_4) {
    do {
      ...
      (**(code **)(**(int **)(_DAT_109d5e68 + 0x54) + 0x188))(&uStack_38);
      iVar4 = iVar4 + 1;
    } while (iVar4 < sStack_4);
  }
  _Logf_FOutputDevice__QAAXPBGZZ
            (*(undefined4 *)_GNetworkLog__3PAVFOutputDevice__A_exref,&UNK_107c2788);
  uVar3 = (**(code **)(*__GL2Console__3PAVUL2ConsoleWnd__A + 0x2c0))
                    (__GL2Console__3PAVUL2ConsoleWnd__A,2,&UNK_107c2788);
