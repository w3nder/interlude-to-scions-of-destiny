...
uint packet_10419e90(uint param_1,undefined4 param_2)

{
  ...
  puStack_c = &UNK_10756708;
  uStack_10 = *unaff_FS_OFFSET;
  *unaff_FS_OFFSET = &uStack_10;
  puStack_14 = &stack0xffffffb8;
  iStack_8 = 0;
  func_0x10305079(*(undefined4 *)(param_1 + 0x48),param_2,&UNK_107c69c0,auStack_1c,&uStack_20,
                  &uStack_24,(int)&param_1 + 3,&uStack_15);
  piVar2 = (int *)0x0;
  if (_DAT_109d5e68 != 0) {
      ...
      if (*piVar2 == 1) {
        ...
        if (piVar2[1] != 0) {
          ...
          if (iVar1 != 0) {
            ...
            (**(code **)(**(int **)(_DAT_109d5e68 + 0x54) + 0x6a4))
                      (*(undefined4 *)(iVar1 + 0x158),auStack_3c);
            _Logf_FOutputDevice__QAAXPBGZZ
                      (*(undefined4 *)_GNetworkLog__3PAVFOutputDevice__A_exref,&UNK_107c6968);
            (**(code **)(*__GL2Console__3PAVUL2ConsoleWnd__A + 0x2c0))
                      (__GL2Console__3PAVUL2ConsoleWnd__A,2,&UNK_107c6968);
