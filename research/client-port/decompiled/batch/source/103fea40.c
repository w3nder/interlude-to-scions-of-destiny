...
uint packet_103fea40(int param_1,undefined4 param_2)
  ...
  *unaff_FS_OFFSET = &uStack_10;
  ...
  for (iStack_18 = 0; iStack_18 < (short)uStack_1c; iStack_18 = iStack_18 + 1) {
    ...
    uVar2 = func_0x10305079(*(undefined4 *)(iVar1 + 0x48),uVar2,&UNK_107c1638,&uStack_54,&uStack_50,
                            ...
                            &uStack_34);
    (**(code **)(**(int **)(_DAT_109d5e68 + 0x54) + 0x4f4))((int)(short)param_1,auStack_58);
    if (((short)param_1 == 2) || ((short)param_1 == 3)) {
      (**(code **)(**(int **)(_DAT_109d5e68 + 0x54) + 0x32c))(uStack_54);
    }
  }
  _Logf_FOutputDevice__QAAXPBGZZ
            (*(undefined4 *)_GNetworkLog__3PAVFOutputDevice__A_exref,&UNK_107c1698);
  uVar3 = (**(code **)(*__GL2Console__3PAVUL2ConsoleWnd__A + 0x2c0))
                    (__GL2Console__3PAVUL2ConsoleWnd__A,2,&UNK_107c1698);
  *unaff_FS_OFFSET = uStack_10;
