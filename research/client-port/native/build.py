...
common=['-std=c++17','-O2','-Wall','-Wextra','-Werror','-fno-exceptions','-fno-rtti',str(ROOT/'protocol_core.cpp'),str(ROOT/'clan_codec.cpp'),str(ROOT/'schema_codec.cpp'),str(ROOT/'structured_codec.cpp'),str(ROOT/'outbound_policy.cpp'),str(ROOT/'asset_codec.cpp'),str(ROOT/'character_codec.cpp'),str(ROOT/'pledge_bridge.cpp'),str(ROOT/'status_codec.cpp')]
