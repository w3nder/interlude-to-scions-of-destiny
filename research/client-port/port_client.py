...
def main():
    ...
    if args.action=='package':
        ...
        write(dest/'manifest.json',{'build':'protocol-hooks-6-assets-audit','dll_sha256':build_hash,'required_engine_sha256':coverage['target_sha256'],'requires':'existing l2.exe autoload bootstrap from LoginTest build','validation':validation})
